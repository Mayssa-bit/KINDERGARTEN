...
import tn.esprit.spring.Repository.PrivilegeRepository;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Transactional
    private final Users createUserIfNotFound(final String email, final String firstName, final String lastName, final String password, final Collection<Role> roles) {
